    ...
    <>
      ...
      <div className="backup-feature">
        ...
        <div>
          ...
          <p>
            Операции сохраняются на сервере. Войдите в свою учётную запись на телефоне или компьютере — и
            работайте с общими данными.
          </p>
      ...
      <section className="panel">
        <div className="section-title">
          <div>
            ...
            <p>Скачайте отдельный день или очистите старую историю</p>
          </div>
        ...
        {!data.sales.length && <p className="muted">Запишите первую продажу — её день появится в списке.</p>}
      ...
      {purging && (
        ...
        >
          <p className="modal-text">
            Выбранные записи продаж будут удалены из базы. Остатки на складе не увеличатся: суммарный расход
